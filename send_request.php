    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label for="vehicle_name" class="control-label">Varian Kendaraan (Contoh: BeAT)</label>
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">Keterangan</label>
                ...
                <div class="form-group">
                    <label for="service_type" class="control-label">Request</label>
